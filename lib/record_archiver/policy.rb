...
module RecordArchiver
  ...
  class Policy
    ...
    def initialize(model, **options)
      ...
      @deleted_column       = (options[:deleted_column] || RecordArchiver.config.deleted_column).to_sym
    ...
    def batch_size_value
      batch_size || RecordArchiver.config.batch_size
    end

    def delete_after_archive?
      @delete_after_archive.nil? ? RecordArchiver.config.delete_after_archive : @delete_after_archive
    end

    def delete_method_value
      delete_method || RecordArchiver.config.delete_method
    end
    ...
    def default_column
      @deleted ? @deleted_column : RecordArchiver.config.timestamp_column
    end
